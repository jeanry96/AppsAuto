...
<h3><i class="fa fa-angle-right"></i> Upload Data <strong>Autodebet Listrik</strong></h3>
    <div class="row mt">
        <div class="col-lg-12">
            ...
            @endif
          <form id="fileupload" action="{{ url('/upload/listik/excel') }}" method="POST" enctype="multipart/form-data">
